...
class K4CRSI_1h(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if trade.is_short:
            if (current_time - trade.open_date_utc).seconds/3600 < 3:
                if current_rate>last_candle['kc_0_mid']:
                    return 'hit kc_0 mid'
            else:
                if current_rate>last_candle['kc_0_lower']:
            ...
            if (current_time - trade.open_date_utc).seconds/3600 < 3:
                ...
                if current_rate<last_candle['kc_0_upper']:
